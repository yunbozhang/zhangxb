    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" action="/index.php/Home/Borrow/renew_act" id="renew_borrow">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">借款人</label>
                        <div class="col-sm-3">
                            <p class="form-control-static"><?php echo ($borrow_list["name"]); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" value="<?php echo ($borrow_list["borrow_money"]); ?>" name="borrow_money" aria-required="true" aria-invalid="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" value="<?php echo ($borrow_list["borrow_interest_rate"]); ?>" name="borrow_interest_rate" aria-required="true" aria-invalid="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" value="<?php echo ($borrow_list["borrow_procedures_rate"]); ?>" name="borrow_procedures_rate" aria-required="true" aria-invalid="true">
                            <span class="help-block m-b-none">%</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <input type="hidden" name="borrow_uid" value="<?php echo ($borrow_list["borrow_uid"]); ?>">
