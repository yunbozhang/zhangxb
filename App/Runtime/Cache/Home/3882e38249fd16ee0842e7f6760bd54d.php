                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal"  id="edit_user">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="name" value="<?php echo ($user["name"]); ?>" aria-required="true" aria-invalid="true">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="phone" value="<?php echo ($user["phone"]); ?>" aria-required="true" aria-invalid="true">
                            </div>
                        </div>
