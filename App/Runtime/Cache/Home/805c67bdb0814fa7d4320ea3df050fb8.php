...
<div class="row">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-sm-1">
                            <a data-type="xls" href="/index.php/Home/Borrow/add" type="button" class="btn btn-danger btn-sm">添加新借款</a>
                    </div>
                </div>
    ...
    <div class="modal inmodal fade" id="confirm_procedures" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
              <div class="modal-dialog modal-sm">
                  <form method="post" class="form-horizontal" action="/index.php/Home/Borrow/confirm_procedures">
